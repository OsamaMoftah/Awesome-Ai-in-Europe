...
> A curated list of resources for building AI systems in Europe (the **+** signifies the inclusion of the UK and Switzerland) — infrastructure, models, datasets, compliance tooling, funding, and community.
